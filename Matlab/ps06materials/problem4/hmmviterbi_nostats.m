function [currentState, logP] = hmmviterbi_nostats(seq,tr,e,varargin)

%   HMMVITERBI_NOSTATS calculates the most probable state path for a sequence.
...
%   Adapted from hmmviterbi, Copyright 1993-2011 The MathWorks, Inc.
