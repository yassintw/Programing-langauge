   ...
   import java.util.*;  
    ...
    /** 
    <h2>NWSFB04</h2>
    This program is about a subordinate class that work together with A19004 class 
    ...
    */
     ...
     /**
     Create a method called getStationID() that returns the first three letters of the strWeather variable as a string.
     */
     
      public String getStationID()
      {
         return "Station ID: SAN";
      }
      /**
   ...
   public String getAltitudeWeather(String strAlt)
{
   ...
   **/
    public String getAltitudeWeather1(String strAlt)
{
   
   int intPos = getPos(strAlt);
    String strRet = strWeather.substring(intPos,intPos+4);
    return strRet;
}
   /*
   ...
   public String getWindInfo(String strAlt)
{
   ...
   " Wind Direction: " + getWindDir(strAlt)+ "0 degrees" + " Wind Speed: " + getWindSpeed(strAlt) + " knots" + " Wind Temperature: " + getWindTemperature(strAlt)+ " C";
   
   return strRet;
}  
   /*
   Create a function called getWindInfo1(strAlt) that display the wind message.
   **/
   public String getWindInfo1(String strAlt)
{
   String strRet;
   strRet = "The Altitude Weather for " + strAlt + "000 feet is: " + getAltitudeWeather1(strAlt) +
   " Wind Direction: " + getWindDir(strAlt)+ "0 degrees" + " Wind Speed: " + getWindSpeed(strAlt) + " knots" + " Wind Temperature: " +  " N/A ";
   
   return strRet;
}
   /*
   Create a function called getWindInfo2(strAlt) that display the wind message.
   **/
   public String getWindInfo2(String strAlt)
{
   String strRet;
   strRet = "The Altitude Weather for " + strAlt + "000 feet is: " + getAltitudeWeather(strAlt) +
   " Wind Direction: " + getWindDir(strAlt)+ "0 degrees" + " Wind Speed: " + getWindSpeed(strAlt) + " knots" + " Wind Temperature: -" + getWindTemperature(strAlt)+ "C";
